...
// Shared star-tree behavior
// multiindex_t loads one shared starkd and assigns the same pointer to all contained index_t objects
// serial shard emulation, preserve current behavior
// hreaded sharding, treat multiindex as a special case until startree / kdtree query reentrancy is proven
